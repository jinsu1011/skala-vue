...
const MOCK_COMMENT = {
  ...
  city_09: '빌딩 숲 사이로 강한 돌풍이 들이칠 수 있으니 유의하세요.',
  city_10: '해양성 기후의 영향으로 맑은 날에도 구름이 갑작스럽게 낄 수 있습니다.',
  city_11: '안개와 비가 잦은 도시이므로 외출 시 작은 우산을 항상 휴대하세요.',
  city_12: '아름다운 세느강 인근으로 밤낮간 은은한 바람이 불어옵니다.',
  city_13: '대륙성 고기압의 영향으로 건조하고 기온 변화 폭이 클 수 있습니다.',
  city_14: '북방 대륙의 쌀쌀한 공기가 유입되니 든든한 겉옷을 챙기세요.',
  city_15: '이베리아 반도의 고원 지대로 한낮의 강렬한 햇살에 대비하세요.',
  city_16: '태평양 난류의 영향으로 사계절 온화하고 상쾌한 일조량을 자랑합니다.',
  city_17: '지중해성 기후로 한여름에는 맑고 건조하며 볕이 몹시 뜨겁습니다.',
  city_18: '사막 기후 특성상 맑고 매우 건조하며 일교차가 큽니다.',
  city_19: '히말라야 고지대 특유의 청량한 맑은 공기와 가파른 기온 편차를 겪습니다.',
  city_20: '내륙 고원에 위치해 맑고 쾌적한 초원 날씨와 귀여운 동물들을 만날 수 있습니다.',
  city_21: '열대 대서양의 훈풍이 불어오며 역동적이고 눈부신 해변 날씨를 보입니다.',
  city_22: '지구에서 가장 춥고 극한의 건조한 거센 팽귄들의 흰 눈 덮인 툰드라 대지입니다.',
  city_23: '북극성 아래 얼음판과 바위들이 어우러진 차갑고 청명한 백야/극야 구역입니다.',
}
...
<template>
  <div class="detail-page">
    ...
    <section v-else class="unknown-city">
      ...
      <p class="unknown-sub">아래의 등록된 도시 목록에서 선택해 주세요.</p>
